          ...
          <TooltipProvider>
            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/admin/quizzes" element={<Navigate to="/admin" state={{ defaultTab: "quizzes" }} />} />
                <Route path="/admin/assignments" element={<Navigate to="/admin" state={{ defaultTab: "assignments" }} />} />
