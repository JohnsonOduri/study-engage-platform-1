...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `
    Generate a structured learning course about "${title}" that spans ${durationDays} days.
    ...
    1. A title
    2. Detailed theory explanation (at least 200 words)
    ...
    try {
      ...
      console.log('Successfully generated course for:', title);
